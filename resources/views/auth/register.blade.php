                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="col-md-4 col-form-label text-md-right" for="company">Компания :</label>
                            <div class="col-md-6">
                            <select class="form-control align-content-lg-between" id="company" name="company_id">
